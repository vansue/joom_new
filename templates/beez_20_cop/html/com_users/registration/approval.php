...
<h1>Override component Đăng ký người dùng</h1>
...
<?php endforeach;?>
		<div>
			<fieldset>
				...
				<p><input type="checkbox" name="tos_agree" /> <?php echo JText::_('BEEZ_20_COPY_AGREE'); ?></p>
				<?php if ($this->params->get('show_age_checkbox')) : ?>
				<p><input type="checkbox" name="old_enough" /> <?php echo JText::_('BEEZ_20_COPY_AGE'); ?></p>
				<?php endif;?>
			</fieldset>
